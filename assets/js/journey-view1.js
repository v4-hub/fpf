    ...
    require([
        ...
        // --- Event Listeners Setup ---
         function setupEventListeners() {
             ...
             // Settings Panel
             settingsBtn?.addEventListener('click', () => { if (isSettingCenter) endSetCenterPointMode(); settingsPanel.style.display = settingsPanel.style.display === 'block' ? 'none' : 'block'; footprintsListPanel.style.display = 'none'; });
